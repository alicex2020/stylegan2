...
def training_loop(
    ...
    # resume_pkl              = './results/00023-stylegan2-stylegan2_dataset-1gpu-config-f/network-snapshot-000180.pkl',     # Network pickle to resume training from, None = train from scratch.
    resume_pkl              = None,
    ...
    print(f'How often to save image snapshots: {image_snapshot_ticks}')
    print(f'How often to save network snapshots: {network_snapshot_ticks}')
